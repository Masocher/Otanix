...
const CharactersFilters = () => {
  ...
  const charactersFiltersStatus = useSelector(
    (rootReducer) => rootReducer.charactersFiltersReducer
  );
  ...
  return (
    <div
      className={`filters_container ${charactersFiltersStatus ? "show" : ""}`}
    >
      <div className="filters">
        ...
        <div
          ...
          onClick={() => {
            dispatch(openCharactersFilters());
            setGenre(false);
            setAge(false);
            setScore(false);
          }}
